...
@section('title', 'SK Keputusan RPL Diterbitkan')
    ...
    <div style="background-color: #f2f3ff; border-radius: 12px; padding: 24px; margin-bottom: 24px; text-align: left;">
        <table role="presentation" cellspacing="0" cellpadding="0" style="width: 100%; border-collapse: collapse;">
            <tr>
                ...
                <td style="padding: 12px 0; color: #004ac6; font-size: 18px; font-weight: 700; border-bottom: 1px solid #dae2fd;">{{ $sk->total_sks_diakui }} SKS</td>
            </tr>
            <tr>
                <td style="padding: 12px 0; color: #54647a; font-size: 14px; border-bottom: 1px solid #dae2fd;">Nomor SK</td>
                <td style="padding: 12px 0; color: #131b2e; font-size: 14px; font-weight: 600; border-bottom: 1px solid #dae2fd;">{{ $sk->nomor_sk ?? '-' }}</td>
            </tr>
            <tr>
                <td style="padding: 12px 0; color: #54647a; font-size: 14px;">Tanggal SK</td>
                <td style="padding: 12px 0; color: #131b2e; font-size: 14px; font-weight: 600;">{{ $sk->tanggal_terbit ? \Carbon\Carbon::parse($sk->tanggal_terbit)->translatedFormat('d F Y') : '-' }}</td>
            </tr>
        </table>
    </div>
