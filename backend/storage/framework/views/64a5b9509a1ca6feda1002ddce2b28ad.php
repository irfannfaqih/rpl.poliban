...
<title><?php echo $__env->yieldContent('title', 'SIRPL Poliban'); ?></title>
...
<body style="margin: 0; padding: 0; background-color: #ffffff; color: #131b2e; font-family: 'Plus Jakarta Sans', Arial, sans-serif; -webkit-font-smoothing: antialiased;">
        ...
        <tr>
            <td align="center" style="padding-top: 32px;">
                ...
                <p style="font-size: 14px; color: #434655; line-height: 1.5; margin: 0;">
                    Butuh bantuan? Kunjungi halaman <a href="<?php echo e(config('app.frontend_url', 'http://localhost:3000')); ?>/bantuan" style="color: #004ac6; text-decoration: underline; font-weight: 500;">Bantuan</a> atau email kami di <a href="mailto:support@poliban.ac.id" style="color: #004ac6; text-decoration: underline; font-weight: 500;">support@poliban.ac.id</a>.
                </p>
            </td>
        </tr>
    </table>
    ...
    <div style="background-color: #ffffff; border-top: 1px solid #c3c6d7; width: 100%; padding: 24px 16px; text-align: center; box-sizing: border-box;">
        ...
        <p style="font-size: 11px; color: #737686; line-height: 1.5; margin: 0;">
            &copy; <?php echo e(date('Y')); ?> SIRPL Poliban. Email ini dikirim secara otomatis.
        </p>
    </div>
</body>
</html>
<?php /**PATH C:\SIRPL - Backup 3 june 2026\backend\resources\views/emails/layout.blade.php ENDPATH**/ ?>