...
import { ChevronRight, ClipboardCheck, KeyRound, LogOut } from "lucide-react";
...
function KaprodiSidebar() {
  ...
  const isActive = pathname === "/kaprodi/pleno-approval";
    ...
    <div className="flex h-full w-64 flex-col">
      ...
      <nav className="flex-1 space-y-1 overflow-y-auto px-3 py-4">
        ...
        >
          ...
          <span className="flex-1">Approval Pleno</span>
